<div class="gs-page-content">
    <div class="gs-table-content">
        <input type="hidden" id="sort_by_column" name="sort_by_column" value="<?php echo $sort_by_column;?>"/>
        <input type="hidden" id="sort_by_direction" name="sort_by_direction" value="<?php echo $sort_by_direction;?>"/>
        <table class="gs-accounts">
            <thead>
                <tr>
                    <th><input type="checkbox" class="allchk" name="allchk"/></th>
                    <th id="header-subscriber"><?php esc_html_e( 'Subscriber', 'gs-cm' ); ?></th>
                    <th id="header-status"><?php esc_html_e( 'Status', 'gs-cm' ); ?></th>
                    <th id="header-expiration"><?php esc_html_e( 'Expiration', 'gs-cm' ); ?></th>
                    <th><?php esc_html_e( 'State', 'gs-cm' ); ?></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr data-id="<?php echo $r->id;?>">
                    ...
                    <td><?php
                        $subscr_name = pms_get_member_subscription_meta( $r->id, 'pms_group_name', true );
                        if (empty($subscr_name)) {
                    ...
                    <td><?php echo date("n/j/Y", strtotime($r->expiration_date)); ?></td>
                    <td><?php echo get_user_meta($r->user_id, 'address_state', true); ?></td>
                    <td>
                        ...
                        <a href="/subscriber/account-usage-download?edit_user=<?php echo $r->user_id;?>&download=csv" class="s-usage"><?php esc_html_e( 'Usage', 'gs-cm' ); ?></a>
                    </td>
                </tr>
                <?php endforeach;?>
            </tbody>
