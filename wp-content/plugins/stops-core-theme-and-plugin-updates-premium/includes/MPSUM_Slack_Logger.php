...
if (class_exists('MPSUM_Slack_Logger')) return;

/**
 * Class MPSUM_Slack_Logger
 */
class MPSUM_Slack_Logger extends MPSUM_Abstract_Logger {

	protected $allow_multiple = true;

	/**
	 * MPSUM_Slack_Logger constructor
	 *
	...
	public function get_description() {
		return __('Log events into Slack', 'stops-core-theme-and-plugin-updates');
	}
	...
	public function get_options_list() {
		return array(
			'slack_webhook_url' => array(
				__('Slack webhook URL', 'stops-core-theme-and-plugin-updates'),
				'url', // validator
			)
		);
	}
	...
	public function log($level, $message, array $context = array()) {
		...
		$prefix  = '[' . MPSUM_Log_Levels::to_text($level) . ']: ';
	...
	protected function post_message($message) {
		...
		$logger_name = $this->get_option('logger_name', 'EUM Logger');
