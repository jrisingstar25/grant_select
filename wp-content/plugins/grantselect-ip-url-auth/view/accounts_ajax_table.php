<div class="gs-page-content">
    <div class="gs-table-content">
        ...
        <table class="gs-iua-accounts">
            <thead>
                <tr>
                    <th id="header-username"><?php esc_html_e( 'Username', 'iua' ); ?></th>
                    <th id="header-useremail"><?php esc_html_e( 'Email', 'iua' ); ?></th>
                    <th id="header-groupname"><?php esc_html_e( 'Group Name', 'iua' ); ?></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr data-id="<?php echo $r->ID;?>">
                    ...
                    <td>
                        <?php
                        if ($r->pms_group_id != null){
                            echo pms_get_member_subscription_meta( $r->pms_group_id, 'pms_group_name', true );
                        }
                        ?>
                    </td>
                    <td>
                    <?php
                        if ($r->pms_group_id == null){
                            echo '<a href="#" class="apply-group">Assign</a>';
                        }
                    ?>
                    </td>
                </tr>
...
<div class="confirm_modal self-reg-assign" style="display:none;">
