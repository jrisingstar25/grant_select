    ...
    <tbody>
        <?php foreach( $payments as $payment ): ?>
            <tr>
                ...
                <td class="pms-payment-date"><?php echo ucfirst( date_i18n( apply_filters( 'pms_payment_history_date_format', 'F j, Y, g:i A' ), strtotime( $payment->date ) + ( get_option( 'gmt_offset' ) * HOUR_IN_SECONDS ) ) ); ?></td>
